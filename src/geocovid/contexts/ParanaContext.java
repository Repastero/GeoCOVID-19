...
public class ParanaContext extends SubContext {
	...
	public void updateLockdownPhase(int phase) {
		...
		case 229: // 17 agosto
			...
			buildingManager.limitPublicTransportActCap(DataSet.PUBLIC_TRANSPORT_MAX_SEAT + DataSet.PUBLIC_TRANSPORT_MAX_STILL); //Aforo normal desde el principio se ocupan los 31 sitios y adem�s 10 lugares parados
																 //fuente: ------
