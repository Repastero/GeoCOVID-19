...
public final class DataSet {
	...
	public static final double[] ASX_INFECTIOUS_RATE = {74d, 74d, 42d, 42d, 10d};	// % 42 en total de ser infectado asintomatico
	...
	public static final double[] LOCAL_HUMANS_PER_AGE_GROUP		= {10d, 30d, 40d, 20d,  0d}; // Humanos con hogar dentro y trabajo/estudio fuera
