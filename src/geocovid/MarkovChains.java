...
public final class MarkovChains {
	...
	public static final int YOUNG_SEC11_AUGUST_DIFF[][][] = {
			...
			{ {  75,-125, -50,100 }, {  50,-150, -25, 125 }, {  75, -45, -80, 50 }, {  75, -75, -50,  50 } },
	...
	public static final int ADULT_SEC2_AUGUST_DIFF[][][] = {
			...
			{ { 250, -75,-100,-75 }, { 700,-175,-300,-225 }, { 600,-100,-375,-125 }, { 300,   0,-125,-175 } } };
	...
	public static final int YOUNG_SEC2_SEPTEMBER_DIFF[][][] = {
			{ {  75,-100,  25,  0 }, { 75,-100, 25,   0 }, { 75,-100,  25,  0 }, { 75,-100, 25,   0 } },
			{ {   0, -10,   5,  5 }, { 15,  -5,  5, -15 }, { 15,  -5,   5,-15 }, { 15,  -5,  5, -15 } },
			{ {  75, -75,-100,100 }, { 75,-200, 25, 100 }, { 75, -25,-100, 50 }, { 75, -75,-50,  50 } },
			{ { 250, -50,-150,-50 }, {250, -50,-75,-125 }, {100,   0, -75,-25 }, {100,   0,  0,-100 } } };
	public static final int YOUNG_SEC11_SEPTEMBER_DIFF[][][] = {
			{ {  25, -75,  50,  0 }, { 25, -75,  50,  0 }, { 25, -75,  50,  0 }, { 25, -75, 50,   0 } },
			{ { -25, -10,  35,  0 }, { 30,  -5, -20, -5 }, { 30,  -5, -20, -5 }, { 30,  -5,-20,  -5 } },
			{ {  50, -50, -50, 50 }, { 25, -50, -25, 50 }, { 50, -25, -25,  0 }, { 50, -25,-25,   0 } },
			{ { 200, -50,-125,-25 }, {200, -50,-100,-50 }, {125,   0,-125,  0 }, {150,   0,-75, -75 } } };

	public static final int ADULT_SEC2_SEPTEMBER_DIFF[][][] = {
			{ {  75, -75,  0,  0 }, { 75,-75,   0,   0 }, { 75,-75,   0,  0 }, { 75,-75,   0,   0 } },
			{ { -25, -10, 10, 25 }, { 25,-25,   0,   0 }, {  0,  0, -25, 25 }, {  0,  0, -25,  25 } },
			{ { -75, -25, 50, 50 }, {  0,-75,  50,  25 }, {-25,-50,  50, 25 }, {-25,-50,  50,  25 } },
	...
	public static final int ADULT_SEC11_SEPTEMBER_DIFF[][][] = {
			...
			{ { -25, -10, 10, 25 }, {  0, -25,   0,  25 }, {-25,  0, -25, 50 }, {-25,   0,-25, 50 } },
			{ {  50, -50,  0,  0 }, { 50,-100,  50,   0 }, { 50,-50,  25,-25 }, { 50, -50, 25,-25 } },
			{ { 150, -25,-75,-50 }, {300, -50,-150,-100 }, {250,-25,-150,-75 }, {150,   0,-75,-75 } } };
	...
	public static final int HIGHER_SEC11_SEPTEMBER_DIFF[][][] = {
			...
			{ {  0, 0,  0,  0 }, {  0, 0,-25, 25 }, {  0, 0,-25, 25 }, {  0, 0,-25, 25 } },
			{ { 40, 0,-40,  0 }, { 80, 0,-40,-40 }, { 25, 0,  0,-25 }, { 25, 0,  0,-25 } },
			{ { 10, 0, -5, -5 }, { 10, 0, -5, -5 }, { 10, 0, -5, -5 }, { 10, 0, -5, -5 } } };
