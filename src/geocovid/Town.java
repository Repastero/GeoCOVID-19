...
public final class Town {
	...
	private static final int[][] DEFAULT_PHASES_DAYS = {
			{163,201,215,229,254,257,264,273,302,310,340,343,348,358,359,365,366,376,397,411,425,435,445,456,459,460,471,487,494,507,516,523,527,538,556,572,583,607,640},	// pna
			{163,201,215,229,254,257,264,273,302,310,    343,348,358,359,365,366,376,397,411,425,435,445,456,459,460,471,487,494,507,516,523,527,538,556,572,583,607,640},	// gchu 
			{163,201,215,    254,257,264,281,302,310,    343,348,358,359,365,366,376,397,411,425,435,445,456,459,460,471,487,494,507,516,523,527,538,556,572,583,607,640}	// concord
	};
	
	/** Cambios en % de unidades de transporte publico */
	private final double[] PUBLIC_TRANSPORT_QUANTIFICATION	= {0.22, 0.28, 0.34, 0.4, 0.45, 0.51, 0.75, 0.875}; // Junio 2020 a Agosto 2021
	...
	public boolean setTown(String town) {
		...
		case "parana": // 73% del depto.
			setTownData(
				...
				new int[] {163,182,201,215,229,244,254,257,264,273,302,310,340,343,348,358,359,365,366,376,397,411,425,435,445,456,459,460,471,487,494,507,516,523,527,538,556,572,583,586,607,640},
				182,
				120,
				false);
			break;
		...
		case "gualeguaychu": // 76% del depto.
			setTownData(
				...
				new int[] {163,201,215,229,244,254,257,264,273,302,310,343,348,358,359,365,366,376,397,411,425,435,445,456,459,460,471,487,494,507,516,523,527,538,556,572,583,607,640},
				182,
